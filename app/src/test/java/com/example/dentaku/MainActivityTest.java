...
public class MainActivityTest {
    ...
    /**
     * 足し算の計算で、入力値が負の値で小数点以下の値が有る場合
     * 計算処理が行われ、小数点以下を含めた値がViewに設定されること
     * 演算フラグ：プラス
     * 入力値：負の値、小数点以下有り
     * 期待値：Viewに設定されるテキスト=計算結果の値（小数点以下有り）
     */
    @Test
    public void plusNegativeDecimal() {
        // 演算子：足し算
        int operator = this.FLG_PLUS;
        // 入力値X
        float x = -45.234f;
    ...
    /**
     * 掛け算の計算で、入力値が負の値で小数点以下の値が有るの場合
     * 計算処理が行われ、小数点以下も含めた値がViewに設定されること
     * 演算フラグ：かける
     * 入力値：負の値、小数点以下有り
     * 期待値：Viewに設定されるテキスト=計算結果の値（小数点以下有り）
     */
    @Test
    public void timesNegativeDecimal() {
        // 演算子：掛け算
        int operator = this.FLG_TIMES;
        // 入力値X
        float x = -3.625f;
     ...
     */
    @Test
    public void dividedNegativeDecimal() {
        // 演算子：割り算
        int operator = this.FLG_DIVIDED;
        // 入力値X
        float x = -582.42f;
